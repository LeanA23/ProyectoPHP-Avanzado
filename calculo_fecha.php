      ...
      <section>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="unidad2.php">Unidad 2</a></li>
                ...
                <div class="form-group col-sm-6">
                  <?php
                     if ($_POST){
                        ...
                        if ($fecha>$fecha_act){
                          $calc=strtotime($fecha)-strtotime($fecha_act);
                          $dias=intval($calc/86400);
                          echo "<p>Faltan $dias dias para la fecha ingresada</p>";
                        }else{
                          echo "<p>La fecha ingresada es menor a la actual, ingrese otra fecha</p>";
                        }
                     }
                  ?>
                  <a class="btn btn-primary" href="unidad2.php" role="button">Volver</a>
                </div>        
         <div>
    </section>
    <footer>
...
if ($_POST){
    ...
    if (checkdate($mes,$dia,$anio)){
       $rta="<p>La fecha es correcta</p>";
    } else{
       $rta="<p>La fecha es incorrecta</p>";
    }
    $_POST['rta']=$rta;
}*/
?>